 ...
 */
export function createUnitHealthProbe(unit = DEVICE_SHELL_UNIT) {
    return {
        probe() {
 ...
 */
export function composeInstallDependencies(options) {
    ...
    if (registry.keys.length === 0) {
        return {
            ...
            detail: registry.rejected.length === 0
...
//# sourceMappingURL=release-runtime.js.map