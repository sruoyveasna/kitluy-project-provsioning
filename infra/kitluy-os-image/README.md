...
```bash
bash infra/kitluy-os-image/scripts/build-rpi-image.sh --profile store-hub
...
```bash
bash infra/kitluy-os-image/scripts/doctor.sh              # host readiness
bash infra/kitluy-os-image/scripts/scan-image-secrets.sh <rootfs> [more...]
