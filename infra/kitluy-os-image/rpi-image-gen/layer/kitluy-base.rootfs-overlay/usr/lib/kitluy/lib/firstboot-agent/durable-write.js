 ...
 */
import { closeSync, fsyncSync, mkdirSync, openSync, readdirSync, renameSync, rmSync, statSync, symlinkSync, writeFileSync, } from "node:fs";
 ...
 */
export function fsyncDir(directory) {
 ...
 */
export function writeDurable(path, contents, mode = 0o644) {
 ...
 */
export function swapSymlinkDurable(linkPath, target) {
...
//# sourceMappingURL=durable-write.js.map