...
| 28  | Credential delivery to Store Hub  | —                                                                                                                          | —                                                                                                              | —           | **NOT STARTED**        | later WS-11 work. P04B's LAN lifecycle matrix READS the `terminal_device` projection this path must WRITE                      |
