 ...
 *
 * This is a deliberate copy of the Admin Portal's file, not an import. The two
 * portals are separate deployments with separate environments, and a shared
 * runtime-config module would make one portal's misconfiguration a build-time
 * dependency of the other. The contract is three public values; if it grows,
