...
**Version:** v1.0.0
**Date:** 2026-07-26
**Decision under review:** KLD-2026-07-26-002 (proposal) —
[full analysis](../../../decisions/kitluy-contract-vocabulary-and-edge-api-owner-decision-v1.0.0.md)
**Status:** Every group is **OWNER-APPROVAL-REQUIRED**. Approve with five
checkmarks, or strike a group and pick a listed alternative. Nothing is
deployed; every rejected name is REJECTED-BEFORE-IMPLEMENTATION (no aliases).
Hub mutation routes stay blocked (`services/kitluy-hub-agent/src/lan-api.ts`)
until this ballot is decided.

---

## ☐ Group 1 — `/edge/v1` routes
