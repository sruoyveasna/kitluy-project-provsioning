...
| ID | File | Version | Authority class | Role | Status |
| --- | --- | --- | --- | --- | --- |
| KLSRC-0103 | CODEOWNERS |  | OWNER-INSTRUCTION | REPOSITORY-GOVERNANCE-FILE | CANONICAL-CURRENT |
| KLSRC-0104 | CONTRIBUTING.md |  | OWNER-INSTRUCTION | REPOSITORY-GOVERNANCE-FILE | CANONICAL-CURRENT |
| KLSRC-0106 | SECURITY.md |  | OWNER-INSTRUCTION | REPOSITORY-GOVERNANCE-FILE | CANONICAL-CURRENT |
| KLSRC-0125 | kitluy-branching-commit-and-pull-request-policy-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | ENGINEERING-STANDARD | CANONICAL-CURRENT |
| KLSRC-0127 | kitluy-code-review-checklist-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | ENGINEERING-STANDARD | CANONICAL-CURRENT |
| KLSRC-0128 | kitluy-coding-standards-typescript-react-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | ENGINEERING-STANDARD | CANONICAL-CURRENT |
| KLSRC-0131 | kitluy-database-coding-standard-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | ENGINEERING-STANDARD | CANONICAL-CURRENT |
| KLSRC-0133 | kitluy-definition-of-done-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | ENGINEERING-STANDARD | CANONICAL-CURRENT |
| KLSRC-0134 | kitluy-dependency-and-supply-chain-policy-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | ENGINEERING-STANDARD | CANONICAL-CURRENT |
| KLSRC-0138 | kitluy-error-handling-and-logging-standard-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | ENGINEERING-STANDARD | CANONICAL-CURRENT |
| KLSRC-0142 | kitluy-monorepo-blueprint-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | ENGINEERING-STANDARD | CANONICAL-CURRENT |
| KLSRC-0145 | kitluy-package-boundary-and-dependency-rules-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | ENGINEERING-STANDARD | CANONICAL-CURRENT |
| KLSRC-0159 | kitluy-testing-standard-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | ENGINEERING-STANDARD | CANONICAL-CURRENT |
| KLSRC-0160 | pack-manifest.json |  | OWNER-INSTRUCTION | PACK-INDEX (Engineering Standards Pack; selected | CANONICAL-CURRENT |

## infrastructure/ (15)

| ID | File | Version | Authority class | Role | Status |
| --- | --- | --- | --- | --- | --- |
| KLSRC-0105 | PACKAGE_MANIFEST.txt |  | CURRENT-INFRASTRUCTURE-SPECIFICATION | PACK-INDEX (Infrastructure/Operations Pack) | CANONICAL-CURRENT |
| KLSRC-0124 | kitluy-backup-and-disaster-recovery-v1.0.0.md | 1.0.0 | CURRENT-INFRASTRUCTURE-SPECIFICATION | INFRASTRUCTURE-OPERATIONS-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0126 | kitluy-ci-cd-pipeline-v1.0.0.md | 1.0.0 | CURRENT-INFRASTRUCTURE-SPECIFICATION | INFRASTRUCTURE-OPERATIONS-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0132 | kitluy-database-deployment-runbook-v1.0.0.md | 1.0.0 | CURRENT-INFRASTRUCTURE-SPECIFICATION | INFRASTRUCTURE-OPERATIONS-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0135 | kitluy-deployment-topology-phase1-v1.0.0.md | 1.0.0 | CURRENT-INFRASTRUCTURE-SPECIFICATION | INFRASTRUCTURE-OPERATIONS-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0136 | kitluy-domain-dns-and-tls-plan-v1.0.0.md | 1.0.0 | CURRENT-INFRASTRUCTURE-SPECIFICATION | INFRASTRUCTURE-OPERATIONS-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0137 | kitluy-environment-matrix-v1.0.0.md | 1.0.0 | CURRENT-INFRASTRUCTURE-SPECIFICATION | INFRASTRUCTURE-OPERATIONS-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0140 | kitluy-incident-response-runbook-v1.0.0.md | 1.0.0 | CURRENT-INFRASTRUCTURE-SPECIFICATION | INFRASTRUCTURE-OPERATIONS-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0141 | kitluy-infrastructure-as-code-plan-v1.0.0.md | 1.0.0 | CURRENT-INFRASTRUCTURE-SPECIFICATION | INFRASTRUCTURE-OPERATIONS-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0143 | kitluy-observability-and-alert-registry-v1.0.0.md | 1.0.0 | CURRENT-INFRASTRUCTURE-SPECIFICATION | INFRASTRUCTURE-OPERATIONS-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0148 | kitluy-phase1-go-live-checklist-v1.0.0.md | 1.0.0 | CURRENT-INFRASTRUCTURE-SPECIFICATION | INFRASTRUCTURE-OPERATIONS-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0150 | kitluy-phase1-pilot-runbook-v1.0.0.md | 1.0.0 | CURRENT-INFRASTRUCTURE-SPECIFICATION | INFRASTRUCTURE-OPERATIONS-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0153 | kitluy-release-channel-and-promotion-policy-v1.0.0.md | 1.0.0 | CURRENT-INFRASTRUCTURE-SPECIFICATION | INFRASTRUCTURE-OPERATIONS-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0155 | kitluy-rollback-and-emergency-change-runbook-v1.0.0.md | 1.0.0 | CURRENT-INFRASTRUCTURE-SPECIFICATION | INFRASTRUCTURE-OPERATIONS-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0156 | kitluy-secrets-inventory-v1.0.0.md | 1.0.0 | CURRENT-INFRASTRUCTURE-SPECIFICATION | INFRASTRUCTURE-OPERATIONS-CONTRACT | CANONICAL-CURRENT |
...
| ID | File | Version | Authority class | Role | Status |
| --- | --- | --- | --- | --- | --- |
| KLSRC-0107 | kitluy-ai-swarm-operating-system-v1.0.0/00_AI_HANDOFF/000_ACTIVE_PHASE.md | 1.0.0 | OWNER-INSTRUCTION | AI-SWARM-OPERATING-SYSTEM | CANONICAL-CURRENT |
| KLSRC-0108 | kitluy-ai-swarm-operating-system-v1.0.0/00_AI_HANDOFF/000_BLOCKERS.md | 1.0.0 | OWNER-INSTRUCTION | AI-SWARM-OPERATING-SYSTEM | CANONICAL-CURRENT |
| KLSRC-0109 | kitluy-ai-swarm-operating-system-v1.0.0/00_AI_HANDOFF/000_CURRENT_STATE.md | 1.0.0 | OWNER-INSTRUCTION | AI-SWARM-OPERATING-SYSTEM | CANONICAL-CURRENT |
| KLSRC-0110 | kitluy-ai-swarm-operating-system-v1.0.0/00_AI_HANDOFF/000_INDEX.md | 1.0.0 | OWNER-INSTRUCTION | AI-SWARM-OPERATING-SYSTEM | CANONICAL-CURRENT |
| KLSRC-0111 | kitluy-ai-swarm-operating-system-v1.0.0/00_AI_HANDOFF/CONFLICT_TEMPLATE.md | 1.0.0 | OWNER-INSTRUCTION | AI-SWARM-OPERATING-SYSTEM | CANONICAL-CURRENT |
| KLSRC-0112 | kitluy-ai-swarm-operating-system-v1.0.0/00_AI_HANDOFF/EVIDENCE_TEMPLATE.md | 1.0.0 | OWNER-INSTRUCTION | AI-SWARM-OPERATING-SYSTEM | CANONICAL-CURRENT |
| KLSRC-0113 | kitluy-ai-swarm-operating-system-v1.0.0/00_AI_HANDOFF/HANDOFF_TEMPLATE.md | 1.0.0 | OWNER-INSTRUCTION | AI-SWARM-OPERATING-SYSTEM | CANONICAL-CURRENT |
| KLSRC-0114 | kitluy-ai-swarm-operating-system-v1.0.0/00_AI_HANDOFF/REVIEW_TEMPLATE.md | 1.0.0 | OWNER-INSTRUCTION | AI-SWARM-OPERATING-SYSTEM | CANONICAL-CURRENT |
| KLSRC-0115 | kitluy-ai-swarm-operating-system-v1.0.0/00_AI_HANDOFF/ROLLBACK_TEMPLATE.md | 1.0.0 | OWNER-INSTRUCTION | AI-SWARM-OPERATING-SYSTEM | CANONICAL-CURRENT |
| KLSRC-0116 | kitluy-ai-swarm-operating-system-v1.0.0/00_AI_HANDOFF/TASK_TEMPLATE.md | 1.0.0 | OWNER-INSTRUCTION | AI-SWARM-OPERATING-SYSTEM | CANONICAL-CURRENT |
| KLSRC-0117 | kitluy-ai-swarm-operating-system-v1.0.0/AGENTS.md | 1.0.0 | OWNER-INSTRUCTION | AI-SWARM-OPERATING-SYSTEM | CANONICAL-CURRENT |
| KLSRC-0118 | kitluy-ai-swarm-operating-system-v1.0.0/AI_SWARM_PACK_MANIFEST.md | 1.0.0 | OWNER-INSTRUCTION | AI-SWARM-OPERATING-SYSTEM | CANONICAL-CURRENT |
| KLSRC-0119 | kitluy-ai-swarm-operating-system-v1.0.0/CLAUDE.md | 1.0.0 | OWNER-INSTRUCTION | AI-SWARM-OPERATING-SYSTEM | CANONICAL-CURRENT |
| KLSRC-0120 | kitluy-ai-swarm-operating-system-v1.0.0/CONTRIBUTING.md | 1.0.0 | OWNER-INSTRUCTION | AI-SWARM-OPERATING-SYSTEM | CANONICAL-CURRENT |
...
| ID | File | Version | Authority class | Role | Status |
| --- | --- | --- | --- | --- | --- |
| KLSRC-0129 | kitluy-contract-test-matrix-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | QA-TEST-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0130 | kitluy-cross-product-e2e-matrix-phase1-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | QA-TEST-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0139 | kitluy-hardware-certification-test-plan-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | QA-TEST-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0144 | kitluy-offline-and-reconnect-test-pack-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | QA-TEST-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0146 | kitluy-payment-and-reconciliation-test-vectors-v1.0.0.json | 1.0.0 | CANONICAL-SHARED-CONTRACT | TEST-VECTORS (payments/reconciliation) | CANONICAL-CURRENT |
| KLSRC-0147 | kitluy-performance-and-capacity-test-plan-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | QA-TEST-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0149 | kitluy-phase1-master-test-plan-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | QA-TEST-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0151 | kitluy-pilot-evidence-template-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | QA-TEST-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0152 | kitluy-rebuild-test-checklist-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | QA-TEST-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0154 | kitluy-rls-and-tenant-isolation-test-pack-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | QA-TEST-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0157 | kitluy-security-test-plan-v1.0.0.md | 1.0.0 | CANONICAL-SHARED-CONTRACT | QA-TEST-CONTRACT | CANONICAL-CURRENT |
| KLSRC-0158 | kitluy-test-case-registry-phase1-v1.0.0.csv | 1.0.0 | CANONICAL-SHARED-CONTRACT | TEST-CASE-REGISTRY (525 cases, SPECIFIED_NOT_EXE | CANONICAL-CURRENT |
