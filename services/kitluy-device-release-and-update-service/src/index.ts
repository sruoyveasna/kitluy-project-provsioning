/**
 * kitluy-device-release-and-update-service — Device release and update — signed release manifests, Internal/Pilot/Stable channels, A/B rollback (RB v4 §6.8)
 *
...
export const SERVICE_NAME = "kitluy-device-release-and-update-service" as const;
