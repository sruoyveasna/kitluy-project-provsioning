# kitluy-commerce-store-api

Governed Commerce Store API — storefronts, customer commerce and headless surfaces (RB v4 §10.1); Phase 1 exposes only the approved Laundry storefront subset
