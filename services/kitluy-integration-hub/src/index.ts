/**
 * kitluy-integration-hub — Integration Hub — governed external channel and connector administration foundation
 *
...
export const SERVICE_NAME = "kitluy-integration-hub" as const;
