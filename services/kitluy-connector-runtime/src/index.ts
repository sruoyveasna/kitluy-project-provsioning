/**
 * kitluy-connector-runtime — Connector Runtime — executes certified connectors in isolation with scoped credentials only
 *
...
export const SERVICE_NAME = "kitluy-connector-runtime" as const;
