# kitluy-edge-operations-api

Governed Edge Operations API — Store Hub, POS Desktop, POS Mobile and approved local devices; Location-scoped offline-first contracts (RB v4 §10.1)
