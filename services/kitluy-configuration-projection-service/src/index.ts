/**
 * kitluy-configuration-projection-service — Configuration projection — versioned cloud configuration to Store Location activation packages (RB v4 §3.4)
 *
...
export const SERVICE_NAME = "kitluy-configuration-projection-service" as const;
